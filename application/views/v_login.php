...
<head>
  ...
  <link href="<?php echo base_url(); ?>gambar/website/logo_smk.png" rel="icon">
  <title>SMK AL HAFIDZ LEUWILIANG | Login</title>
...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="<?php echo base_url(); ?>assets/index2.html"><b>Portal</b>SMK Al Hafidz Leuwiliang</a>
    </div>
    <!-- /.login-logo -->
